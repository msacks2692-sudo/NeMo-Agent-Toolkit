...
## 2024-10-25 - [Async filtering anti-pattern in FunctionGroup]
...
**Action:** Replace `await` calls inside `for` loops with `asyncio.gather` over a pre-filtered list of candidates when applying asynchronous inclusion/exclusion conditions.
