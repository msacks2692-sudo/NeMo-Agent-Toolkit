...
## 2025-01-20 - [Optimize distance-based regex matches]
...
**Action:** Instead, precompile the regex pattern and iterate through `re.finditer(...)`, short-circuiting (`break`) the loop as soon as the calculated distance from the target point begins to increase. This yields significant performance gains on large strings.
