        ...
        try:
            ...
            if "'" in tool_input:
                try:
                    ...
                    logger.debug("%s Unable to parse structured tool input. Using raw input.", AGENT_LOG_PREFIX)
            else:
                # If there are no single quotes, it's not a quote issue, fall back directly
                tool_input_parsed = tool_input
