...
class RedTeamingMiddleware(FunctionMiddleware):
    ...
    * Type-safe operations on strings, numbers
    ...
    def _find_middle_sentence_index(self, text: str) -> int:
        ...
        # Iterate through matches and find the one closest to the middle
        for match in _SENTENCE_PATTERN.finditer(text):
            ...
            if dist < min_distance:
                ...
                # Since match.end() is monotonically increasing, once the distance
                # starts to increase, it will only continue to increase.
                break
