...
def _validate_single_fn(single_fn: SingleCallableT | None) -> tuple[type, type]:
    ...
    if (sig.parameters[list(sig.parameters)[0]].annotation == sig.empty):
...
class FunctionDescriptor:
    ...
    def from_function(func: Callable) -> 'FunctionDescriptor':
        ...
        if (arg_count == 0):
            ...
            first_annotation = sig.parameters[list(sig.parameters)[0]].annotation
    ...
    def from_fn(fn: SingleCallableT | StreamCallableT,
        ...
        if (inspect.isasyncgenfunction(fn)):
            ...
            if (output_origin == typing.Annotated):
                ...
                if (stream_arg):
                    single_input_type = sig.parameters[list(sig.parameters)[0]].annotation
